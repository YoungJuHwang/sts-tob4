 ...
 <div class = "회원가입" >
  ...
  <div class = "jumbotron">
    ...
    <div class = "form-group" style="white-space:nowrap;">
      <label class= "control-label col-sm-3" style="white-space:nowrap;" for="text" >이메일</label>
      <div class= "col-sm-4" style="white-space:nowrap;">         
        <input type= "text" class = "form-control" id="email" style="white-space:nowrap;" placeholder= "아이디" >
        <select name="birth">
